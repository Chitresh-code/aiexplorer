...
Source table: `aihubdb.dbo.implementationtimespan`

## Columns

| Column | Type | Nullable | Default | Collation |
| --- | --- | --- | --- | --- |
| id | bigint | NO | NEXT VALUE FOR [dbo].[seq_implementationtimespan] |  |
| timespan | nvarchar(255) | YES |  | SQL_Latin1_General_CP1_CI_AS |
...
- `pk_implementationtimespan` PRIMARY KEY (id)
