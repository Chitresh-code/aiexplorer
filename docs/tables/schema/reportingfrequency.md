...
Source table: `aihubdb.dbo.reportingfrequency`

## Columns

| Column | Type | Nullable | Default | Collation |
| --- | --- | --- | --- | --- |
| id | bigint | NO | NEXT VALUE FOR [dbo].[seq_reportingfrequency] |  |
| frequency | nvarchar(255) | YES |  | SQL_Latin1_General_CP1_CI_AS |
...
- `pk_reportingfrequency` PRIMARY KEY (id)
